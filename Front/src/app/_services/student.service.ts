...
export class StudentService {
  ...
  filterStudent(filterStudent: IFilterStudent) {
    ...
    if (filterStudent.initialAge)
      params = params.append('initialAge', filterStudent.initialAge);
    if (filterStudent.finalAge)
      params = params.append('finalAge', filterStudent.finalAge);
    if (filterStudent.ownCollege)
      params = params.append('ownCollege', filterStudent.ownCollege);
    if (filterStudent.interests)
      params = params.append('interests', filterStudent.interests.join(','));
    if (filterStudent.pageNumber)
      params = params.append('pageNumber', filterStudent.pageNumber);
